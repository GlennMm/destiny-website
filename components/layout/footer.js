			...
			<div class="container">
				<div class="row">
						...
						<div class="single-widget pr-60">
							...
							<div class="footer-social">
								<ul>
									...
									<li><a href="https://wa.me/"><i class="zmdi zmdi-whatsapp"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-6 pt-4 pt-lg-0">
						<div class="single-widget">
							<h3>get in touch</h3>
							<p>Destiny Achievers Group of Schools, Plot 12, Glenforest, Borrowdale, Harare</p>
							<p>+263 783 713 096 <br>+263 717 698 404</p>
							<p>info@destiny.ac.zw</p>
						</div>
					</div>
				</div>
			</div>
